...
class RemoveFormRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_form(
        self,
        name: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_form_mapped_args(
            name=name,
        )
        return await self._aremove_form_oapg(
    ...
    def remove_form(
        ...
        return self._remove_form_oapg(
            path_params=args.path,
        )

class RemoveForm(BaseApi):
    ...
    async def aremove_form(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_form(
            name=name,
            **kwargs,
        )
    ...
    def remove_form(
        ...
        raw_response = self.raw.remove_form(
            name=name,
        )
