...
class BaseApi(api_client.Api):
    ...
    def _remove_account_mapped_args(
        self,
        name: str,
    ...
    async def _aremove_account_oapg(
        self,
...
class RemoveAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_account(
        self,
        name: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_account_mapped_args(
            name=name,
        )
        return await self._aremove_account_oapg(
    ...
    def remove_account(
        ...
        return self._remove_account_oapg(
            path_params=args.path,
        )

class RemoveAccount(BaseApi):
    ...
    async def aremove_account(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_account(
            name=name,
            **kwargs,
        )
    ...
    def remove_account(
        ...
        raw_response = self.raw.remove_account(
            name=name,
        )
