...
class PayToolsApiModelsPayerDetailsNoIpAddress(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["countryCode", "address1", "address2", "address3", "postCode", "city", "stateProvince", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["countryCode", "address1", "address2", "address3", "postCode", "city", "stateProvince", ], str]):
