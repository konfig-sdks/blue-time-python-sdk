...
class PayToolsApiModelsAuthRequestModel(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["currency", "card", "amount", "isDigital", "orderDesc", "payerDetails", "myRef", "paymentGatewayAccountName", "certificateName", "paymentGatewayAccount", "networkTokenBrand", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["currency", "card", "amount", "isDigital", "orderDesc", "payerDetails", "myRef", "paymentGatewayAccountName", "certificateName", "paymentGatewayAccount", "networkTokenBrand", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        card: 'PayToolsApiModelsCardInputModel',
        isDigital: typing.Union[MetaOapg.properties.isDigital, bool, schemas.Unset] = schemas.unset,
