...
from blue_time_python_sdk.model.pay_tools_api_models_auth_request_model import PayToolsApiModelsAuthRequestModel as PayToolsApiModelsAuthRequestModelSchema
...
from blue_time_python_sdk.type.pay_tools_api_models_auth_request_model import PayToolsApiModelsAuthRequestModel
...
from blue_time_python_sdk.pydantic.pay_tools_api_models_auth_request_model import PayToolsApiModelsAuthRequestModel as PayToolsApiModelsAuthRequestModelPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PayToolsApiModelsAuthRequestModelSchema


request_body_pay_tools_api_models_auth_request_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _perform_authorize_operation_mapped_args(
        self,
        currency: str,
        card: PayToolsApiModelsCardInputModel,
        amount: typing.Union[int, float],
        is_digital: typing.Optional[bool] = None,
        order_desc: typing.Optional[typing.Optional[str]] = None,
        ...
        if is_digital is not None:
            _body["isDigital"] = is_digital
        if order_desc is not None:
            _body["orderDesc"] = order_desc
    ...
    async def _aperform_authorize_operation_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/PaymentGateway/authorize',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_pay_tools_api_models_auth_request_model.serialize(body, content_type)
    ...
    def _perform_authorize_operation_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class PerformAuthorizeOperationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aperform_authorize_operation(
        self,
        currency: str,
        card: PayToolsApiModelsCardInputModel,
        amount: typing.Union[int, float],
        ...
        **kwargs,
        ...
        args = self._perform_authorize_operation_mapped_args(
            currency=currency,
            card=card,
            amount=amount,
        ...
        return await self._aperform_authorize_operation_oapg(
            body=args.body,
            **kwargs,
        )
    
    def perform_authorize_operation(
        self,
        currency: str,
        card: PayToolsApiModelsCardInputModel,
        amount: typing.Union[int, float],
        ...
        return self._perform_authorize_operation_oapg(
            body=args.body,
        )

class PerformAuthorizeOperation(BaseApi):
    ...
    async def aperform_authorize_operation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aperform_authorize_operation(
            currency=currency,
            card=card,
            amount=amount,
            is_digital=is_digital,
    ...
    def perform_authorize_operation(
        ...
        raw_response = self.raw.perform_authorize_operation(
            currency=currency,
            card=card,
            amount=amount,
            is_digital=is_digital,
