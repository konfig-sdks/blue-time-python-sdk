...
class RequiredPayToolsApiModelsCaptureVoidRequestModel(TypedDict):
...
class OptionalPayToolsApiModelsCaptureVoidRequestModel(TypedDict, total=False):
...
class PayToolsApiModelsCaptureVoidRequestModel(RequiredPayToolsApiModelsCaptureVoidRequestModel, OptionalPayToolsApiModelsCaptureVoidRequestModel):
    pass
