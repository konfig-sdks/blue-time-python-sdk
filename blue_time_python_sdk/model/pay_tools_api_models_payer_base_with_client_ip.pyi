...
class PayToolsApiModelsPayerBaseWithClientIp(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["clientIPAddress", "countryCode", "city", "stateProvince", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["clientIPAddress", "countryCode", "city", "stateProvince", ], str]):
