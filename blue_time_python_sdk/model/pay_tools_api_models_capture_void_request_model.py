...
class PayToolsApiModelsCaptureVoidRequestModel(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["currency", "refTransId", "card", "amount", "myRef", "paymentGatewayAccountName", "certificateName", "paymentGatewayAccount", "networkTokenBrand", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["currency", "refTransId", "card", "amount", "myRef", "paymentGatewayAccountName", "certificateName", "paymentGatewayAccount", "networkTokenBrand", ], str]):
