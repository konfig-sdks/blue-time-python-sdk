...
class RequiredPayToolsApiModelsPaymentGatewayAccountInputModel(TypedDict):
    pass

class OptionalPayToolsApiModelsPaymentGatewayAccountInputModel(TypedDict, total=False):
...
class PayToolsApiModelsPaymentGatewayAccountInputModel(RequiredPayToolsApiModelsPaymentGatewayAccountInputModel, OptionalPayToolsApiModelsPaymentGatewayAccountInputModel):
    pass
