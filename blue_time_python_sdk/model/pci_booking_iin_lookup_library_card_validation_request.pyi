...
class PciBookingIINLookupLibraryCardValidationRequest(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["iin"]) -> MetaOapg.properties.iin: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["iin", "city", "stateProvince", "countryCode", "clientIPAddress", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["iin"]) -> typing.Union[MetaOapg.properties.iin, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["iin", "city", "stateProvince", "countryCode", "clientIPAddress", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        iin: typing.Union[MetaOapg.properties.iin, None, str, schemas.Unset] = schemas.unset,
