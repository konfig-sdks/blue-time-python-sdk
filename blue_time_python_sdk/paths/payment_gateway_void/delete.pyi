...
class BaseApi(api_client.Api):
    ...
    def _void_operation_mapped_args(
        self,
        currency: str,
        ref_trans_id: str,
    ...
    async def _avoid_operation_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/PaymentGateway/void',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class VoidOperationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def avoid_operation(
        self,
        currency: str,
        ref_trans_id: str,
        card: PayToolsApiModelsCardInputModel,
        ...
        **kwargs,
        ...
        args = self._void_operation_mapped_args(
            currency=currency,
        ...
        return await self._avoid_operation_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def void_operation(
        ...
        return self._void_operation_oapg(
            body=args.body,
        )

class VoidOperation(BaseApi):
    ...
    async def avoid_operation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.avoid_operation(
            currency=currency,
            ref_trans_id=ref_trans_id,
            card=card,
            amount=amount,
    ...
    def void_operation(
        ...
        raw_response = self.raw.void_operation(
            currency=currency,
            ref_trans_id=ref_trans_id,
            card=card,
            amount=amount,
