...
class RequiredPayToolsApiModelsPayerDetailsNoIpAddress(TypedDict):
...
class OptionalPayToolsApiModelsPayerDetailsNoIpAddress(TypedDict, total=False):
    # 1st address line
...
class PayToolsApiModelsPayerDetailsNoIpAddress(RequiredPayToolsApiModelsPayerDetailsNoIpAddress, OptionalPayToolsApiModelsPayerDetailsNoIpAddress):
    pass
