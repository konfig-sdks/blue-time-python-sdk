...
class RequiredPayToolsApiModelsPaymentGatewayAccountFullOutputModel(TypedDict):
    pass

class OptionalPayToolsApiModelsPaymentGatewayAccountFullOutputModel(TypedDict, total=False):
    # Name of account
...
class PayToolsApiModelsPaymentGatewayAccountFullOutputModel(RequiredPayToolsApiModelsPaymentGatewayAccountFullOutputModel, OptionalPayToolsApiModelsPaymentGatewayAccountFullOutputModel):
    pass
