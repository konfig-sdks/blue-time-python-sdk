...
class BaseApi(api_client.Api):
    ...
    def _perform_charge_operation_mapped_args(
        self,
        currency: str,
    ...
    async def _aperform_charge_operation_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/PaymentGateway/charge',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _perform_charge_operation_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class PerformChargeOperationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aperform_charge_operation(
        self,
        currency: str,
        card: PayToolsApiModelsCardInputModel,
        amount: typing.Union[int, float],
        ...
        **kwargs,
        ...
        args = self._perform_charge_operation_mapped_args(
            currency=currency,
            card=card,
            amount=amount,
        ...
        return await self._aperform_charge_operation_oapg(
            body=args.body,
            **kwargs,
        )
    
    def perform_charge_operation(
        self,
        currency: str,
        card: PayToolsApiModelsCardInputModel,
        amount: typing.Union[int, float],
        ...
        return self._perform_charge_operation_oapg(
            body=args.body,
        )

class PerformChargeOperation(BaseApi):
    ...
    async def aperform_charge_operation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aperform_charge_operation(
            currency=currency,
            card=card,
            amount=amount,
            is_digital=is_digital,
    ...
    def perform_charge_operation(
        ...
        raw_response = self.raw.perform_charge_operation(
            currency=currency,
            card=card,
            amount=amount,
            is_digital=is_digital,
