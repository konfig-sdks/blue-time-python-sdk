...
class RequiredPayToolsApiModelsAuthRequestModel(TypedDict):
...
class OptionalPayToolsApiModelsAuthRequestModel(TypedDict, total=False):
...
class PayToolsApiModelsAuthRequestModel(RequiredPayToolsApiModelsAuthRequestModel, OptionalPayToolsApiModelsAuthRequestModel):
    pass
