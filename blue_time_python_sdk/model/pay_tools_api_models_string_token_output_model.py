...
class PayToolsApiModelsStringTokenOutputModel(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["clearPayload"]) -> MetaOapg.properties.clearPayload: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["clearPayload", "token", "createTime", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["clearPayload"]) -> typing.Union[MetaOapg.properties.clearPayload, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["clearPayload", "token", "createTime", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        clearPayload: typing.Union[MetaOapg.properties.clearPayload, None, str, schemas.Unset] = schemas.unset,
